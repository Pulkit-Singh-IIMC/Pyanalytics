# -*- coding: utf-8 -*-
"""
Created on Sat Aug  8 21:00:36 2020
...
df = pd.read_csv('E:/analytics/datasets/boston_daily_temps_1978_2019.csv', header=0, infer_datetime_format=True, parse_dates=[0], index_col=[0])
